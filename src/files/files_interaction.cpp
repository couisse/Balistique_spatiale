...
StarShip uploadSettings(std::string filename, std::vector<Astre>* target){
    ...
    target->emplace_back( 5.972 * pow(10,21), Coords(2*3.8*pow(10,5), 2.6*3.8*pow(10,5)), path);

    Orbit path2(Coords(2*3.8*pow(10,5), 2*3.8*pow(10,5)), 2*3.8*pow(10,5), 0.2, M_PI_2);

    target->emplace_back( 5 * pow(10,21), Coords(2*3.8*pow(10,5), 1.4*3.8*pow(10,5)), path2);
